	...
	return (
		<>
			...
			<Box component="main" className={classes.root}>
				...
				>
					<Tab label="Posts" value="Posts" icon={<Icon><PostAdd /></Icon>} />
					<Tab label="IGTV" value="IGTV" icon={<Icon><LiveTv /></Icon>} disabled />
					<Tab label="Saved" value="Saved" icon={<Icon><Bookmark /></Icon>} />
					<Tab
						label="Tagged"
						value="Tagged"
